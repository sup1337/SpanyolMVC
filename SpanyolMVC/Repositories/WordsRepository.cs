...
public class WordsRepository : IWordsRepository
{
    ...
    public async Task<IEnumerable<Words>> GetAllWordsAsync(string? searchQuery = null, int pageNumber = 1,
        int pageSize = 100)
    {
    ...
    public async Task BulkInsertFromExcelAsync(string filePath)
    {
        ...
        for (int row = 2; row <= rowCount; row++) // Feltételezzük, hogy az első sor a fejléc
        {
            var word = new Words
            {
                Difficulty = worksheet.Cells[row, 1].GetCellValue<int>(),
                Hungarian = string.IsNullOrEmpty(worksheet.Cells[row, 2].Text) ? "nincs" : worksheet.Cells[row, 2].Text,
                English = string.IsNullOrEmpty(worksheet.Cells[row, 3].Text) ? "nincs" : worksheet.Cells[row, 3].Text,
                Italian = string.IsNullOrEmpty(worksheet.Cells[row, 4].Text) ? "nincs" : worksheet.Cells[row, 4].Text,
                French = string.IsNullOrEmpty(worksheet.Cells[row, 5].Text) ? "nincs" : worksheet.Cells[row, 5].Text,
                German = string.IsNullOrEmpty(worksheet.Cells[row, 6].Text) ? "nincs" : worksheet.Cells[row, 6].Text,
                Infinitive = worksheet.Cells[row, 7].Text,
                Gerund = worksheet.Cells[row, 8].Text,
                Participle = worksheet.Cells[row, 9].Text,
                Present1 = worksheet.Cells[row, 10].Text,
                Present2 = worksheet.Cells[row, 11].Text,
                Present3 = worksheet.Cells[row, 12].Text,
                Present4 = worksheet.Cells[row, 13].Text,
                Present5 = worksheet.Cells[row, 14].Text,
                Present6 = worksheet.Cells[row, 15].Text,
                Imperfect1 = worksheet.Cells[row, 16].Text,
                Imperfect2 = worksheet.Cells[row, 17].Text,
                Imperfect3 = worksheet.Cells[row, 18].Text,
                Imperfect4 = worksheet.Cells[row, 19].Text,
                Imperfect5 = worksheet.Cells[row, 20].Text,
                Imperfect6 = worksheet.Cells[row, 21].Text,
                Indefinite1 = worksheet.Cells[row, 22].Text,
                Indefinite2 = worksheet.Cells[row, 23].Text,
                Indefinite3 = worksheet.Cells[row, 24].Text,
                Indefinite4 = worksheet.Cells[row, 25].Text,
                Indefinite5 = worksheet.Cells[row, 26].Text,
                Indefinite6 = worksheet.Cells[row, 27].Text,
                Future1 = worksheet.Cells[row, 28].Text,
                Future2 = worksheet.Cells[row, 29].Text,
                Future3 = worksheet.Cells[row, 30].Text,
                Future4 = worksheet.Cells[row, 31].Text,
                Future5 = worksheet.Cells[row, 32].Text,
                Future6 = worksheet.Cells[row, 33].Text,
                Conditional1 = worksheet.Cells[row, 34].Text,
                Conditional2 = worksheet.Cells[row, 35].Text,
                Conditional3 = worksheet.Cells[row, 36].Text,
                Conditional4 = worksheet.Cells[row, 37].Text,
                Conditional5 = worksheet.Cells[row, 38].Text,
                Conditional6 = worksheet.Cells[row, 39].Text,
                SubjunctivePresent1 = worksheet.Cells[row, 40].Text,
                SubjunctivePresent2 = worksheet.Cells[row, 41].Text,
                SubjunctivePresent3 = worksheet.Cells[row, 42].Text,
                SubjunctivePresent4 = worksheet.Cells[row, 43].Text,
                SubjunctivePresent5 = worksheet.Cells[row, 44].Text,
                SubjunctivePresent6 = worksheet.Cells[row, 45].Text,
                SubjunctiveImperfect1 = worksheet.Cells[row, 46].Text,
                SubjunctiveImperfect2 = worksheet.Cells[row, 47].Text,
                SubjunctiveImperfect3 = worksheet.Cells[row, 48].Text,
                SubjunctiveImperfect4 = worksheet.Cells[row, 49].Text,
                SubjunctiveImperfect5 = worksheet.Cells[row, 50].Text,
                SubjunctiveImperfect6 = worksheet.Cells[row, 51].Text,
                ImperativePositive2 = worksheet.Cells[row, 52].Text,
                ImperativePositive3 = worksheet.Cells[row, 53].Text,
                ImperativePositive4 = worksheet.Cells[row, 54].Text,
                ImperativePositive5 = worksheet.Cells[row, 55].Text,
                ImperativePositive6 = worksheet.Cells[row, 56].Text,
                ImperativeNegative2 = worksheet.Cells[row, 57].Text,
                ImperativeNegative3 = worksheet.Cells[row, 58].Text,
                ImperativeNegative4 = worksheet.Cells[row, 59].Text,
                ImperativeNegative5 = worksheet.Cells[row, 60].Text,
                ImperativeNegative6 = worksheet.Cells[row, 61].Text
            };
